...
public class HRMController implements Initializable{
   ...
   public void initialize(URL location, ResourceBundle resources) {
      ...
      List<Employee> employeelst = hrmserv.getEmployeeList();
      
      setTableView(employeelst);
      
      employee_attribute.getItems().addAll("사원번호", "이름", "부서", "직급", "근무지", "사워구분", "입사일자", "전화번호", "이메일", "최종학력");
   ...
   private void setTableView(List<Employee> employeelst) {
      ...
      for(Employee e : employeelst) {
         ...
         //System.out.println(e.getnum() + e.getid() + e.getpw() + e.getname() + e.getbirth() + e.getgender() + e.getcategory() + e.getsalay() + e.getdepartment() + e.getposition() + e.getplace() + e.getphone() + e.getjoin() + e.getemail() + e.geteducation() + e.getaddress() + e.getimage());
      }
   ...
   public void employeeSearch() {
      ...
      List<Employee> employeelst = hrmserv.getEmployeeSearch(attribute, txt);
